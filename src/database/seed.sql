...
INSERT INTO categories (category_name, category_icon, status) VALUES
  ('Vegetables', 'seeded/categories/vegetables.png', 'active'),
  ('Meat',       'seeded/categories/meat.png',       'active'),
  ('Dairy',      'seeded/categories/dairy.png',      'active'),
  ('Grains',     'seeded/categories/grains.png',     'active'),
  ('Pantry',     'seeded/categories/pantry.png',     'active'),
  ('Frozen',     'seeded/categories/frozen.png',     'active'),
  ('Beverages',  'seeded/categories/beverages.png',  'active');
INSERT INTO ingredients (ingredient_name, base_unit) VALUES
  ...
  ('Carrot',         'g'),
  ('Coffee',         'g');
INSERT INTO products (store_id, category_id, ingredient_id, product_name, description, price, stock_quantity, package_quantity, package_unit, image, rating, status) VALUES
  (1, 4, 1, 'Jasmine Rice 1kg',      'Premium fragrant rice.',  6.50, 50, 1000, 'g',   'seeded/products/rice.png',           4.6, 'active'),
  (2, 4, 1, 'Basmati Rice 500g',     'Long grain basmati.',     5.20, 40, 500,  'g',   'seeded/products/rice.png',           4.3, 'active'),
  (1, 2, 2, 'Chicken Breast 500g',   'Skinless chicken breast.',12.00,30, 500,  'g',   'seeded/products/chicken-breast.png', 4.4, 'active'),
  (2, 2, 2, 'Chicken Breast 1kg',    'Bulk pack.',              22.00,20, 1000, 'g',   'seeded/products/chicken-breast.png', 4.1, 'active'),
  (1, 3, 3, 'Free Range Eggs (10)',  'Pack of 10 eggs.',        7.80, 60, 10,   'pcs', 'seeded/products/egg.png',            4.7, 'active'),
  (1, 1, 4, 'Tomatoes 500g',         'Vine ripened.',           4.20, 25, 500,  'g',   'seeded/products/tomato.png',         4.2, 'active'),
  (2, 1, 5, 'Brown Onions 1kg',      'Cooking onions.',         3.90, 35, 1000, 'g',   'seeded/products/onion.png',          4.0, 'active'),
  (1, 5, 8, 'Olive Oil 500ml',       'Extra virgin.',          18.00, 15, 500,  'ml',  'seeded/products/olive-oil.png',      4.8, 'active'),
  (3, 4, 1, 'Premium Rice 2kg',      'Large family rice pack.', 11.80, 18, 2000, 'g',  'seeded/products/rice.png',           4.5, 'active'),
  (3, 3, 9, 'Fresh Milk 1L',         'Full cream milk.',        6.90, 24, 1000, 'ml',  'seeded/products/milk.png',           4.6, 'active'),
  (4, 6, 11, 'Frozen Potato Cubes',  'Ready-to-cook potato cubes.', 8.40, 20, 500, 'g', 'seeded/products/potato.png',        4.1, 'active'),
  (4, 1, 12, 'Carrots 1kg',          'Crunchy carrots.',         5.10, 30, 1000, 'g',  'seeded/products/carrot.png',         4.3, 'active'),
  (3, 5, 13, 'Ground Coffee 250g',    'Medium roast coffee.',    14.50, 12, 250,  'g', 'seeded/products/coffee.png',         4.8, 'active'),
  (2, 3, 9, 'Low Fat Milk 1L',        'Low fat dairy milk.',      6.50, 28, 1000, 'ml', 'seeded/products/milk.png',           4.2, 'active'),
  (1, 3, 10, 'Unsalted Butter 250g',  'Creamy baking butter.',    9.90, 18, 250,  'g',  'seeded/products/butter.png',         4.5, 'active'),
  (3, 1, 4, 'Cherry Tomatoes 250g',   'Sweet salad tomatoes.',    5.80, 22, 250,  'g',  'seeded/products/tomato.png',         4.4, 'active'),
  (4, 1, 5, 'Red Onions 500g',        'Mild red onions.',         3.60, 26, 500,  'g',  'seeded/products/onion.png',          4.1, 'active'),
  (2, 5, 6, 'Garlic Bulbs 200g',      'Fresh aromatic garlic.',   4.50, 24, 200,  'g',  'seeded/products/garlic.png',         4.3, 'active'),
  (3, 5, 7, 'Sea Salt 500g',          'Fine cooking sea salt.',   2.80, 40, 500,  'g',  'seeded/products/salt.png',           4.0, 'active'),
  (2, 5, 8, 'Cooking Olive Oil 1L',   'Everyday olive oil.',     29.90, 12, 1000, 'ml', 'seeded/products/olive-oil.png',      4.5, 'active'),
  (4, 2, 2, 'Chicken Breast 250g',    'Small pack chicken breast.', 6.80, 34, 250, 'g', 'seeded/products/chicken-breast.png', 4.2, 'active'),
...
INSERT INTO recipes (user_id, recipe_title, description, instructions, base_servings, cuisine_type, difficulty, prep_time, cook_time, image, status) VALUES
  ...
  (7, 'Creamy Mashed Potatoes', 'Soft mashed potatoes with butter and milk.', '1. Boil potatoes. 2. Mash with butter and milk. 3. Season to taste.', 4, 'Western', 'easy', 15, 25, 'seeded/recipes/creamy-mashed-potatoes.png', 'active'),
  (8, 'Homemade Carrot Soup', 'A comforting carrot soup.', '1. Sauté garlic and onion. 2. Add carrots and stock. 3. Blend until smooth.', 3, 'Western', 'medium', 15, 30, 'seeded/recipes/homemade-carrot-soup.png', 'active'),
  (9, 'Morning Coffee Blend', 'Simple home coffee recipe.', '1. Measure coffee. 2. Brew with hot water. 3. Serve immediately.', 1, 'Beverage', 'easy', 5, 5, 'seeded/recipes/morning-coffee-blend.png', 'active');
